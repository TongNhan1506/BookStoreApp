...
public class SupplierPanel extends JPanel {
    ...
    private void applyFilter() {
        ...
        for (SupplierDTO supplier : allSuppliers) {
            ...
            String phone = supplier.getPhoneNumber() == null ? "" : supplier.getPhoneNumber().toLowerCase();
    ...
    private void saveSupplier() {
        ...
        supplierDTO.setPhoneNumber(phone);
        ...
        if (selectedSupplierId == -1) {
            ...
            if (oldSupplier != null) {
                ...
                String confirmMessage = "Mọi sách đang dùng thông tin nhà cung cấp cũ sẽ đổi thành thông tin mới.\n\n"
                        ...
                        + "- Địa chỉ: " + oldSupplier.getAddress() + "\n"
                        + "- SĐT: " + oldSupplier.getPhoneNumber() + "\n\n"
                        + "Thông tin mới:\n"
                        + "- Tên: " + supplierDTO.getSupplierName() + "\n"
                        + "- Địa chỉ: " + supplierDTO.getAddress() + "\n"
                        + "- SĐT: " + supplierDTO.getPhoneNumber() + "\n\n"
    ...
    private void showSupplierDetailDialog(int row) {
        ...
        String detailMessage = "Tên nhà cung cấp: " + supplier.getSupplierName() + "\n"
                ...
                + "Số điện thoại: " + supplier.getPhoneNumber() + "\n";
